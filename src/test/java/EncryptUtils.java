...
public class EncryptUtils {
  ...
  //  static Logger logger = Logger.getLogger(EncryptUtils.class);
	/**
	 * 3des解码
	 * 
	 * @param value  待解密字符串
...
//   	try {
//   			logger.info(Base64.encode("5718".getBytes()));
//			String str = EncryptUtils.PasswordEncrypt3DES("5718");
//            logger.info(str);
//            String test = "53 AbpEbkbY=";
//            logger.info(test);
//            String test1 = test.replaceAll(" ", "+");//带加号被转成空格的情况
//            logger.info(test1);
//			String string = EncryptUtils.PasswordDecrypt3DES("vQwTT8pnnF8=");
//            logger.info(string);
//		} catch (Exception e) {
//
//			e.printStackTrace();
//		}
//       try {
//          String s = PasswordDecrypt3DES("BAR2u39/WLw=");
...
//  	}
    ...
    public static void main(String[] args) throws Exception{
        String s = EncryptUtils.PasswordDecrypt3DES("BAR2u39/WLw=");
        System.out.println(s);
    }
